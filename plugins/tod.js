...
const fs = require('fs');
var randomTruth = JSON.parse(fs.readFileSync('./database/truth.json'))
var randomDare = JSON.parse(fs.readFileSync('./database/dare.json'))
let w = Config.WORKTYPE == 'public' ? false:true
...
if (message.buttons === 'truth') await message.client.sendMessage(message.jid, { text: randomTruth },{ quoted: message.data })
	if (message.buttons === 'dare') await message.client.sendMessage(message.jid, { text: randomDare },{ quoted: message.data })
