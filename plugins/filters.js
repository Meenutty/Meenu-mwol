...
await message.client.sendMessage(message.jid, fs.readFileSync('./bgmone/jackz.mp3'), MessageType.audio, { mimetype: Mimetype.mp4Audio, quoted : message.data, ptt: true})
        }
        if (!!message.mention && message.mention[0] == Config.MENTION) {
await message.client.sendMessage(message.jid, fs.readFileSync('./bgmone/Jackz.mp3'), MessageType.audio, { mimetype: Mimetype.mp4Audio, quoted : message.data, ptt: true})
        }
        
const array = ['alive','pushpa','Food','Owner','Bye','Poda','help','Amruser','Da','Happy','Hai','Help','Hi','Hlo','Kozhi','Love','Myr','Myre','Name','ban','bgm','ban','com','group','ayye','Theertha','Romantic','Adhuz','carlo','Carlo','Ooh','frnd','Theja','sathan','Sathan','theja','wizard','Wizard','ooh','Kk','Rafi','rafi','thug','anjali','Anjali','Sed','sed','sad','Love','love','Line','line','Jackz','jackz','Broken','broken','Angelina','angelina','single','Single','Commited','Hi','poda','poli','ayin','Ayin','ayn','vilachil','sense','Mukesh','idiot','Cyber','cyber','tyr','thyr','Thyr','budhi','Myre','myre','Aara','kundan','Kundan','Thug','trance','Trance','aara','Food','food','fud','Fud','Nee','nee','happy','Happy','Sinan','Dud','Photo','photo','fan','Fan','Gd nyt','gd nyt','koi','Koi','vatt','Vatt','ara','Ara','name','Name','pinnalla','Pinnalla','Hai','Reply','reply','thall','Thall','Song','kozhi','Kozhi','I love you','mass','Mass','arulle','Arulle','Mirash','mirash','Mirash bgm','Salman','Arshi','Ezra','ezra','nihal','Nihal','sticker','sufaid','Sufaid','jinn','Jinn','Feel','lub','Lub','foxy','Foxy','Music','music','CR7','Alan','Halo','Aysheri','aysheri','kooi','Kooi','Achumon','ith','🔥','bye','para','Para','mentionameen','Khais','mukesh','Hlo','hlo','njan','Njan','muthe','Muthe','Xxxtentacion','alone','Alone','Converting','potta','Potta','menu','welcome','Welcome','vannu','Vannu','Remove','kyat','rip','remix','Remix','Rip','Myr','dj','Dj','pever','Pever','Oo','XXXTENTACION','Love u','hate','Hate','Njan vannu','tto','Audio','audio','veno','xxxtentacion','Veno','nanban','Ayye','Ronaldo','ronaldo','katha','hy','vaanam','Vaanam','Vanam','Ivan','ivan','Annan','annan','Thayoli','umbi','Umbi','Noob','noob','Nanban','Achu','achu','Ok','Ameen','Shiva','ok','Enth','ameen','enth','nth','Edi','kundi','Kundi','Uff','Dey','Cr7','Poda','Poli','Pm','Plzz','girl','Oi','mp3','nirth','Nirth','good nyt','birthday','HBD','bdy','Birthday','Pattula','Good night','Nth','Mood','Please','Mm','Dance','Ith','thech','caption','Polikk','Aah','Good nyt','Mrng','alive','Di','Bro','avan','converting','Allah','bg','help','Hii','odiko','oho','killadi','oo','Fuck','invite','Bgm','Owner','Group','list','man','Nanba','oii','yo','sad','work','set','remove','thukum','poko','xmedia','commands','Boss','vava','Lalitha','start','sing','Hello','Bye','warn','Baby','who','find','power','myr','vanam','tagall','Re entry','pass','patti','phaa','mone','look','bor','try','owner','luv','feel','romam','potte','no replay','bgm','vijay','Da','Vazha','kunna','Kunna','Sorry','Sry','sorry','sry','Bot','bot','song','Uyir','uyir','thayoli','Hy','Sad','Ayn','BRKNOFC','basil','Brokenofc','jackzser','adhuz'] 
array.map( async (a) => {
let pattern = new RegExp(`\\b${a}\\b`, 'g');
if(pattern.test(message.message)){
       await message.client.sendMessage(message.jid, fs.readFileSync('./bgmone/' + a + '.mp3'), MessageType.audio, { mimetype: Mimetype.mp4Audio,duration: Config.MWOL, quoted: message.data, ptt: true})
}
});
    }
...
Asena.addCommand({on: 'text', fromMe: false}, (async (message, match) => {
        ...
        if(banned !== undefined) return
        if (!!message.mention && message.mention[0] == '918075641889@s.whatsapp.net') {
await message.client.sendMessage(message.jid, fs.readFileSync('./efxaudio/efx4.mp3'), MessageType.audio, { mimetype: Mimetype.mp4Audio, quoted : message.data, ptt: true})
        }
        if (!!message.mention && message.mention[0] == Config.MENTION) {
...
let pattern = new RegExp(`\\b${a}\\b`, 'g');
if(pattern.test(message.message)){
       await message.client.sendMessage(message.jid, fs.readFileSync('./efxaudio/' + a + '.mp3'), MessageType.audio, { mimetype: Mimetype.mp4Audio,duration: Config.MWOL, quoted: message.data, ptt: true})
}
});
    }
