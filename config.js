...
module.exports = {
    ...
    ALL: process.env.ALL_CAPTION === undefined ? 'Made By meenu mwol' : process.env.ALL_CAPTION,
    ...
    BOTLIZA: process.env.BOT_NAME === undefined ? 'MEENU MWOL' : process.env.BOT_NAME,
    ...
    INSTA: process.env.INSTAGRAM === undefined ? 'www.instgram.com/safxr._' : process.env.INSTAGRAM,
    ...
    BOTV2: process.env.BOTV2_NAME === undefined ? 'MEENUTTY' : process.env.BOTV2_NAME,
    LIZA_AI: process.env.LIZA_AI === undefined ? 'false' : process.env.LIZA_AI,
    ALIVEBUTTON: process.env.ALIVEBUTTON === undefined ? 'ALIVE' : process.env.ALIVEBUTTON,
    ALIVE_BUTTON: process.env.ALIVE_BUTTON === undefined ? 'LIST' : process.env.ALIVE_BUTTON,
    LG_LOGO: process.env.LG_LOGO === undefined ? 'https://i.imgur.com/AS0FTAh.jpeg' : process.env.LG_LOGO,
    LOGO_NAME: process.env.LOGO_NAME === undefined ? 'MEENU MWOL' : process.env.LOGO_NAME,
